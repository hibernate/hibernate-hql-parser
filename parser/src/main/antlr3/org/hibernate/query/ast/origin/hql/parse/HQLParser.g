 ...
 * entirety.
 */
package org.hibernate.query.ast.origin.hql.parse;

import java.util.LinkedList;
import java.util.Iterator;
import org.hibernate.query.ast.common.ParserContext;
import org.hibernate.query.ast.tree.EntityNameTree;
}

@parser::members {
	private Stack enableParameterUsage = new Stack();
	private ParserContext context = new org.hibernate.query.ast.DefaultParsingContext();
